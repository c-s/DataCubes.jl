...
facts("NAArrayOperators tests") do
  ...
  context("ifelse tests") do
    @fact ifelse(@nalift([true,false,NA]), 3, 5) --> nalift([3,5,5])
    @fact ifelse(@nalift([true,true,false,NA]), nalift([1,2,3,4]), 5) --> nalift([1,2,5,5])
    @fact ifelse(@nalift([true,true,false,NA]), 5, nalift([1,2,3,4])) --> nalift([5,5,3,4])
    @fact ifelse(@nalift([true,true,false,NA]), 1.0*nalift([1,2,3,4]), 5) --> 1.0*nalift([1,2,5,5])
    @fact ifelse(@nalift([true,true,false,NA]), 5, 1.0*nalift([1,2,3,4])) --> 1.0*nalift([5,5,3,4])
    @fact ifelse(@nalift([true,true,false,NA]), nalift([1,2,3,4]), 5) --> nalift([1,2,5,5])
    @fact ifelse(@nalift([true,true,false,NA]), Nullable(5), nalift([1,2,3,4])) --> nalift([5,5,3,4])
    @fact ifelse(@nalift([true,true,false,NA]), 1.0*nalift([1,2,3,4]), Nullable(5)) --> 1.0*nalift([1,2,5,5])
    @fact ifelse(@nalift([true,true,false,NA]), Nullable(5), 1.0*nalift([1,2,3,4])) --> 1.0*nalift([5,5,3,4])
    @fact ifelse(@nalift([true,true,false,NA]), [1,2,3,4], Nullable(5)) --> nalift([1,2,5,5])
    @fact ifelse(@nalift([true,true,false,NA]), 5, [1,2,3,4]) --> nalift([5,5,3,4])
    @fact ifelse(@nalift([true,true,false,NA]), 1.0*[1,2,3,4], 5) --> 1.0*nalift([1,2,5,5])
    @fact ifelse(@nalift([true,true,false,NA]), 5, 1.0*[1,2,3,4]) --> 1.0*nalift([5,5,3,4])
    @fact ifelse(@nalift([true,true,false,NA]), [1,2,3,4], Nullable(5)) --> nalift([1,2,5,5])
    @fact ifelse(@nalift([true,true,false,NA]), Nullable(5), [1,2,3,4]) --> nalift([5,5,3,4])
    @fact ifelse(@nalift([true,true,false,NA]), 1.0*[1,2,3,4], Nullable(5)) --> 1.0*nalift([1,2,5,5])
    @fact ifelse(@nalift([true,true,false,NA]), Nullable(5), 1.0*[1,2,3,4]) --> 1.0*nalift([5,5,3,4])
